...
def decode_opus_from_file(input_file):
    """
    Decode Opus data from a p3 file and return a list of Opus data packets and the total duration.
    """
    opus_datas = []
    total_frames = 0
    ...
    with open(input_file, 'rb') as f:
        while True:
            ...
            # Read Opus data based on the length specified in the header
...
def decode_opus_from_bytes(input_bytes):
    """
    Decode Opus data from p3 binary data and return a list of Opus data packets and the total duration.
    """
    import io
    opus_datas = []
    total_frames = 0
