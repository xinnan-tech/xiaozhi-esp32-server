...
def get_config_from_api(config):
    ...
    # The server configuration is based on the local
...
def ensure_directories(config):
    ...
    # Create a unified directory (keep the original data directory creation)
...
def merge_configs(default_config, custom_config):
    """
    Recursively merge configurations, custom_config takes priority
