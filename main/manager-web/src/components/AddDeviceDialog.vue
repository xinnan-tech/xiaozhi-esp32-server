  ...
  <el-dialog :visible="visible" @close="handleClose" width="24%" center>
    ...
    <div style="margin: 22px 15px;">
      ...
      <div class="input-46" style="margin-top: 12px;">
        <el-input placeholder="Please enter the 6-digit verification code announced by the device.." v-model="deviceCode" @keyup.enter.native="confirm" />
      </div>
    </div>
        ...
        this.deviceCode, ({ data }) => {
          ...
          if (data.code === 0) {
            ...
            this.$message.success({
              message: 'Device binding successful',
              showClose: true
            });
            this.closeDialog();
          } else {
