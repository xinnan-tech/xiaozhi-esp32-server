<template>
  <el-dialog :visible="dialogVisible" @update:visible="handleVisibleChange" width="57%" center
    ...
    <div style="margin: 0 18px; text-align: left; padding: 10px; border-radius: 10px;">
      ...
      <el-form :model="formData" label-width="120px" label-position="left" class="custom-form">
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 0;">
          <el-form-item label="Provider" prop="supplier" style="flex: 1;">
            <el-select v-model="formData.supplier" placeholder="Select provider" class="custom-select custom-input-bg"
        ...
        <el-form-item label="Documentation URL" prop="docLink" style="margin-bottom: 27px;">
      ...
      <div style="font-size: 20px; font-weight: bold; color: #3d4566; margin-bottom: 15px;">Configuration</div>
      <div style="height: 2px; background: #e9e9e9; margin-bottom: 22px;"></div>
