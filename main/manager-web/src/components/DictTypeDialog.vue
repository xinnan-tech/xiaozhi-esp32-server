    ...
    <el-dialog :title="title" :visible.sync="dialogVisible"  width="30%" @close="handleClose">
        <el-form :model="form" :rules="rules" ref="form" label-width="120px">
            <el-form-item label="Dictionary Type Name" prop="dictName">
                <el-input v-model="form.dictName" placeholder="Please enter dictionary type name"></el-input>
            </el-form-item>
            <el-form-item label="Dictionary Type Code" prop="dictType">
                <el-input v-model="form.dictType" placeholder="Please enter dictionary type code"></el-input>
            </el-form-item>
        </el-form>
