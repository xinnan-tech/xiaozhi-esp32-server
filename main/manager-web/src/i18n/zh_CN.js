export default {
  ...
  'device.customTheme': '自定义主题',
  'device.customThemeConfig': '配置',
  'device.customThemeDialogTitle': '自定义主题',
  'device.customThemeStep1': '芯片配置',
  'device.customThemeStep2': '主题设计',
  'device.customThemeStep3': '效果预览',
  'device.customThemeChipConfigDesc': '请选择您的硬件配置，或从预设配置中快速选择。',
  'device.customThemeDesignDesc': '配置唤醒词、字体、表情和背景来自定义您的小智AI主题。',
  'device.customThemeSummaryDesc': '预览并确认生成包的配置信息。',
  'device.customThemePresetConfig': '预设配置（推荐）',
  'device.customThemeCustomConfig': '自定义配置',
  'device.customThemeCustomHardware': '自定义硬件配置',
  'device.customThemeChip': '芯片',
  'device.customThemeResolution': '分辨率',
  'device.customThemeColor': '颜色',
  'device.customThemeChipModel': '芯片型号',
  'device.customThemeSelectChip': '请选择芯片',
  'device.customThemeScreenWidth': '屏幕宽度',
  'device.customThemeScreenHeight': '屏幕高度',
  'device.customThemeCurrentConfig': '当前配置',
  'device.customThemeInvalidConfig': '请先完成配置',
  'device.customThemeNext': '下一步',
  'device.customThemePrev': '上一步',
  'device.customThemeWakewordTab': '唤醒词配置',
  'device.customThemeFontTab': '字体配置',
  'device.customThemeEmojiTab': '表情集合',
  'device.customThemeBackgroundTab': '聊天背景',
  'device.customThemeBackground': '背景',
  'device.customThemeWakewordDesc': '根据您的芯片型号选择合适的唤醒词模型。',
  'device.customThemeWakewordChipTipC3': '您的芯片支持 WakeNet9s 轻量级模型。',
  'device.customThemeWakewordChipTipS3': '您的芯片支持 WakeNet9s 和 WakeNet7 模型。',
  'device.customThemeSelectWakeword': '选择唤醒词',
  'device.customThemeSelectWakewordPlaceholder': '请选择唤醒词（可选）',
  'device.customThemeSelectedWakeword': '已选择唤醒词',
  'device.customThemeWakewordModel': '模型类型',
  'device.customThemeWakewordFileName': '文件名',
  'device.customThemeTips': '提示',
  'device.customThemeWakewordTip1': '唤醒词是可选的，不配置唤醒词时设备将无法语音唤醒',
  'device.customThemeWakewordTip2C3': 'C3/C6 芯片仅支持 WakeNet9s 轻量级模型',
  'device.customThemeWakewordTip2S3': 'S3/P4 芯片支持 WakeNet9s 和 WakeNet7 模型',
  'device.customThemeWakewordTip3': '选择后可随时更改或取消选择',
  'device.customThemeFontDesc': '选择预设字体或上传自定义字体文件。',
  'device.customThemePresetFont': '预设字体',
  'device.customThemeCustomFont': '自定义字体',
  'device.customThemeFontSize': '字号',
  'device.customThemeFontBpp': '位深',
  'device.customThemeFontCharset': '字符集',
  'device.customThemeFontFileSize': '文件大小',
  'device.customThemeFontUploadText': '将文件拖到此处，或点击上传',
  'device.customThemeFontUploadTip': '支持 TTF, WOFF, WOFF2 格式',
  'device.customThemeFontInvalidFile': '请选择有效的字体文件 (TTF, WOFF, WOFF2)',
  'device.customThemeEmojiDesc': '选择预设表情包或自定义表情图片。',
  'device.customThemePresetEmoji': '预设表情包',
  'device.customThemeCustomEmoji': '自定义表情包',
  'device.customThemeEmojiSize': '尺寸',
  'device.customThemeEmojiUploadTip': '必须上传 neutral 默认表情，其他表情可选。',
  'device.customThemeEmojiClickUpload': '点击上传',
  'device.customThemeEmojiInvalidFile': '请选择有效的PNG或GIF格式图片',
  'device.customThemeEmojiCustom': '自定义表情',
  'device.customThemeBackgroundDesc': '配置浅色和深色模式背景，支持纯色或自定义图片。',
  'device.customThemeLightMode': '浅色模式背景',
  'device.customThemeDarkMode': '深色模式背景',
  'device.customThemeColorBackground': '纯色背景',
  'device.customThemeImageBackground': '图片背景',
  'device.customThemeBackgroundColor': '背景颜色',
  'device.customThemeTextColor': '文字颜色',
  'device.customThemeBackgroundImageUpload': '点击或拖拽上传背景图片',
  'device.customThemeRemoveImage': '移除图片',
  'device.customThemeInvalidImageFile': '请选择有效的图片文件',
  'device.customThemeConfigSummary': '配置摘要',
  'device.customThemeNotConfigured': '未配置',
  'device.customThemeBackgroundConfigured': '已配置',
  'device.customThemeGenerate': '生成',
  'device.customThemeBackgroundPreview': '背景预览',
  'device.customThemeQuickConfig': '快捷配置',
  'device.customThemeGenerateModalTitle': '生成 assets.bin',
  'device.customThemeFileName': '文件名',
  'device.customThemeFileSize': '文件大小',
  'device.customThemeGenerateTime': '生成时间',
  'device.customThemeDownload': '下载 assets.bin',
  'device.customThemeClose': '关闭',
  'device.online': '在线',
  'device.offline': '离线',
