...
def parse_args():
    ...
    parser.add_argument(
        ...
        "-u",
        type=str,
        default="http://192.168.101.243:8088/v1/tts",
        help="URL of the server",
    )
    parser.add_argument(
        "--text", "-t", type=str, required=True, help="",default="你好呀！我是野原新之助，小新！我今年5岁，是双叶幼稚园的小朋友，喜欢调皮捣蛋和恶作剧哦！你有什么想问我的呢？"
    )
    parser.add_argument(
        "--reference_id",
        "-id",
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        default="/Users/lizhongxiang/PycharmProjects/pythonProject/xiaozhi-esp32-server/audio_ref/shinchan.wav",
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="难过的事讨厌的事丢脸的事全都集中起来，在这里，让水冲走所有的烦恼不就好了吗。",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    parser.add_argument(
        "--chunk_length", type=int, default=50, help="Chunk length for synthesis"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--streaming", type=bool, default=True, help="Enable streaming response"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    if response.status_code == 200:
        if args.streaming:
            ...
            size = p.get_sample_size(audio_format)
